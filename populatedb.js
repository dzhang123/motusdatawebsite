...
function cardtypeCreate(cardtype_name, cardtype_description, cb) {
  
  var cardtype = new CardType({name: cardtype_name, description: cardtype_description});
  ...
  cardtype.save(function (err) {
    ...
    console.log('New CardType: ' + cardtype);
    cardtypes.push(cardtype)
    cb(null, cardtype)
  }  );
}

function createCardtypes(cb) {
    async.parallel(
        [
            function(callback) {
...
/*
function cardCreate(title, summary, isbn, author, genre, cb) {
  bookdetail = { 
    title: title,
    summary: summary,
    author: author,
...
function(err, results) {
    if (err) {
        ...
        console.log('CardTytpes: '+ cardtypes);
